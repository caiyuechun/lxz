...
- (IBAction)login_Action:(id)sender {
  ...
  NSDictionary *  param = @{@"username":self.acount_Tf.text,@"password":self.pass_Tf.text,@"isync":@"1",@"openid":self.thirdDic[@"openid"],@"oauth":self.thirdDic[@"oauth"],@"nickname":self.thirdDic[@"nickname"],@"head_pic":self.thirdDic[@"head_pic"]};
...
//                    NSDictionary *userDic = @{@"openid":openId,@"oauth":@"wx",@"nickname":user.nickname,@"head_pic":[user icon]};
                ...
                }else
                {
                    ...
                    [XTool SaveDefaultInfo:responseObject[@"result"] Key:USER_INFO];
