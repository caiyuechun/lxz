...
-(void)setArr:(NSArray *)arr{
    ...
    for (int i = 0; i < _arr.count; i++) {
        ...
        [tagBtn setTitleColor:RGB(100, 100, 100) forState:UIControlStateNormal];
        [self makeCornerRadius:12 borderColor:RGB(180, 180, 180) layer:tagBtn.layer borderWidth:.5];
        markBtn = tagBtn;
